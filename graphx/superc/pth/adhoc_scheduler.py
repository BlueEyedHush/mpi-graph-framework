...
job_name = "t0_{}_{}g_{}_{}".format(node_count*cores_per_node, mem_per_core*node_count*cores_per_node, g_alias, algo)
log_dir = prepare_log_dir()
log_prefix = os.path.join(log_dir, job_name)

cmds = [graphx_test_cli(str(mem_per_core) + "g", graph=g_path, iterations=iter, algo=algo)]
