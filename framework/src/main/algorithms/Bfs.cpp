...
Bfs_Mp_VarMsgLen_1D_1CommsTag::Bfs_Mp_VarMsgLen_1D_1CommsTag(GlobalVertexId _bfsRoot) : Bfs(_bfsRoot) {

}

Bfs_Mp_VarMsgLen_1D_1CommsTag::~Bfs_Mp_VarMsgLen_1D_1CommsTag() {

}

bool Bfs_Mp_VarMsgLen_1D_1CommsTag::run(GraphPartition *g) {
	int currentNodeId;
	MPI_Comm_rank(MPI_COMM_WORLD, &currentNodeId);
	int worldSize;
	MPI_Comm_size(MPI_COMM_WORLD, &worldSize);
